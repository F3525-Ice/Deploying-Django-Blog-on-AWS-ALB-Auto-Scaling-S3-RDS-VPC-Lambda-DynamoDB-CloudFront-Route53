...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/calimero/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/calimero/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'django-rds.cjzykx2eumij.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'calimeroawscapstonesblog' # please enter your s3 bucket name
